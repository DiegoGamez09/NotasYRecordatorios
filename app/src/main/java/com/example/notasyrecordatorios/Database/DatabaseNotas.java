...
public class DatabaseNotas extends SQLiteOpenHelper {
    ...
    private static final String columnAudio = "audio";
    ...
    public void agregarNota(String titulo, String descripcion, String imagen, String video, String audio){
    ...
    public void ActualizarNota(String titulo, String descripcion, String id, String imagen, String video, String audio){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(columnTitulo,titulo);
        cv.put(columnDescripcion,descripcion);
